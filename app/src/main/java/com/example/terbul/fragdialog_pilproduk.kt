...
import com.example.terbul.database.*
import com.example.terbul.databinding.FragmentdialogProdukBinding
import kotlinx.android.synthetic.main.fragmentdialog_produk.*

class fragdialog_pilproduk (
    private val Produk: produk
) : DialogFragment() {
    private lateinit var binding: FragmentdialogProdukBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragmentdialog_produk,container,false)
        return binding.root
    }
