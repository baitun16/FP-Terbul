...
import com.example.terbul.database.temppesproduk


class temppesadapter internal constructor(context: Context) : RecyclerView.Adapter<temppesadapter.temppesprodukViewHolder>() {
